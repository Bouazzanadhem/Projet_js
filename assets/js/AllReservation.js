         ...
         match +=`
              <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                  <div class="grids5-info">
                    ...
                    <button type="button"   onclick=" update(${x.id})" style="margin-top:30px"  data-bs-toggle="modal" data-bs-target="#exampleModal" href="#"class="btn btn-style btn-success"  >Accept match  </button>
